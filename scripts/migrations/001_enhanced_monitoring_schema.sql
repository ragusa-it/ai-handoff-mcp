-- Enhanced Session Monitoring Schema Migration
-- This migration adds new tables and columns for comprehensive session lifecycle management,
-- monitoring capabilities, and operational insights.

-- Add new columns to existing sessions table for monitoring
...
-- Add performance tracking columns to context_history table
...
CREATE TABLE IF NOT EXISTS session_lifecycle (
    ...
    event_type VARCHAR(50) NOT NULL, -- 'created', 'expired', 'archived', 'dormant', 'reactivated'
...
-- Create indexes for optimal query performance on new tables
...
-- Context history performance indexes
...
VALUES ('migration_completed', 1, 'counter', jsonb_build_object(
    'migration_name', '001_enhanced_monitoring_schema',
    'completed_at', NOW()
));